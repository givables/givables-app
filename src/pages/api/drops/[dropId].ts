export default function handler(req, res) {
  ...
  res.status(200).json({
    ...
    styles: [
      "Industrial Design, Painting, 3D Photography, Graphic Design Sculpture & MultiMedia Work",
    ],
    artists: [
      "Alejandro Molestina (GD 2022)",
      "Arlo Walker (ID 2022)",
      "Cameron Galley (GD 2021)",
      "Gregory Shark (Photo 2021)",
      "Kartik Tuli (GD 2021)",
      "Lucas Ansel (FAV 2023)",
      "Owen McCallum-Keeler (Paint 2023)",
      "Quinn Lockwood (GD 2023)",
      "Ray Steele (Paint 2022)",
      "Sedona Cohen (Paint 2023)",
      "Yasemin Sarihan (GD 2023)",
    ],
    description:
      "The Givables RISD Collection features work from current and recently graduated, up and coming designers of various majors from the Rhode Island School of Design (RISD). RISD is a world class institution, and the premiere art and design school of the United States.",
    pieces: [
      {
        id: "0",
